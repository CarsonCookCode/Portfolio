...
function increaseSize(x) {
    x.style = "transform: scale(1.1); transition: transform 2s";
}

function increaseSmallSize(x) {
    x.style = "transform: scale(1.01); transition: transform 1s";
}

function increaseLargeSize(x) {
    x.style = "transform: scale(1.3); transition: transform 2s; color: white";
}